...
145670821000119000	18 digits; ends in 000 but no reconstruction exists in the release"""
    ...
    assert results == [{'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.NOT_TRAILING_ZEROES',
                          ...
                          'validity': True},
  'other_data': {'react_key': 0,
                 'rest_of_line': '\t16 digits; does not have appropriate '
                                 'pattern of trailing zeroes to be corrupted'}},
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.POSSIBLE_CORRUPTION_UNAMBIG',
                          ...
                          'r_cid_pt': 'Requires information in '
                                      'aphasia-accessible format',
 ...
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.POSSIBLE_CORRUPTION_UNAMBIG',
                          ...
                          'sctid_provided_trailing_zeroes': '0',
                          'validity': False},
  'other_data': {'react_key': 2,
                 'rest_of_line': '\t16 digits; can be reconstructed to a '
                                 'Description Id (provided allow Description '
                                 'Ids)'}},
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.ANY_CORRUPTION_IS_SILENT',
 ...
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.POSSIBLE_CORRUPTION_UNAMBIG',
                          ...
                          'sctid_provided_trailing_zeroes': '0',
                          'validity': True},
  'other_data': {'react_key': 4,
                 'rest_of_line': '\t16 digits; although ends in 0, the '
                                 'provided ID exists in the release, and it is '
                                 'a Description Id. Hence "silent" (provided '
                                 'allow Description Ids)'}},
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.NO_RECONSTRUCTIONS_EXIST',
 ...
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.NO_RECONSTRUCTIONS_EXIST',
                          ...
                          'sctid_provided_trailing_zeroes': '0',
                          'validity': False},
  'other_data': {'react_key': 6,
                 'rest_of_line': '\t16 digits; ends in 0 but reconstruction '
                                 'does not exist in the release (penultimate '
                                 'digit 1)'}},
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.NOT_RECONSTRUCTABLE',
 ...
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.POSSIBLE_CORRUPTION_UNAMBIG',
                          ...
                          'r_cid_pt': 'Dislocation of symphysis pubis in '
                                      'labour and delivery',
 ...
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.POSSIBLE_CORRUPTION_UNAMBIG',
                          ...
                          'sctid_provided_trailing_zeroes': '00',
                          'validity': False},
  'other_data': {'react_key': 10,
                 'rest_of_line': '\t17 digits; can be reconstructed to a '
                                 'Description Id (provided allow Description '
                                 'Ids)'}},
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.POSSIBLE_CORRUPTION_AMBIG',
                          ...
                          'r_did_term': 'Lansoprazole 30mg oral suspension - '
                                        'product',
 ...
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.ANY_CORRUPTION_IS_SILENT',
                          ...
                          'r_cid_pt': 'Disopyramide 100mg capsules (Drugsrus '
                                      'Ltd)',
  ...
  'other_data': {'react_key': 12,
                 'rest_of_line': '\t17 digits; although ends in 00, the '
                                 ...
                                 'digits)'}},
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.AMBIG_COULD_BE_SILENT',
 ...
 {'corruption_analysis': {'outcome_code': {'name': 'OutcomeCodes.AMBIG_COULD_BE_SILENT',
                          ...
                          'r_did_term': 'Qualifying relationship (core '
                                        'metadata concept)',
