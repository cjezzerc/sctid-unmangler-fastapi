"""
This is version using terminology server
It was working but did not seem fast enough and concerned could be problematic
for large lists, so made local sqllite db version instead

Keeping this code in case useful in future
